...
<html lang="en">
<head>
    <title>Material Admin - Register</title>
        ...
        <div class="card contain-sm style-transparent">
            <div class="card-body">
                <div class="row">
                    <div class="col-sm-12">
                        <br/>
                        <span class="text-lg text-bold text-primary">Monitoring</span>
                        <br/><br/>
                        <form class="form floating-label" action="{{ route('register') }}" accept-charset="utf-8" method="post">
                            @csrf
